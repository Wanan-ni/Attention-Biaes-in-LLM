        ...
        **kwargs,
        ...
        Args:
            ...
            kwargs (`dict`, *optional*):
                ...
                into the model
        """
        #print("Qwen2DecoderLayer: attention_mask", attention_mask)
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        #print("Qwen2Model attention_mask:", attention_mask)
        #print("Qwen2Model causal_mask:", causal_mask)
    ...
    def _update_causal_mask(
        ...
        #print("condition:", self.config._attn_implementation == "sdpa" and not (using_static_cache or using_sliding_window_cache) and not output_attentions)
